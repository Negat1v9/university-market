...
func (mr *MockTaskServiceMockRecorder) AttachFiles(ctx, taskID, fileID interface{}) *gomock.Call {
...
func (mr *MockTaskServiceMockRecorder) CompleteTask(ctx, taskID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskServiceMockRecorder) Create(ctx, userID, meta interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskServiceMockRecorder) DeleteTask(ctx, taskID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskServiceMockRecorder) FindOne(ctx, userID, taskID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskServiceMockRecorder) FindUserTasks(ctx, userID, v interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskServiceMockRecorder) PublishTask(ctx, taskID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockTaskService) SelectWorker(ctx context.Context, taskID, userID, workerID string) error {
	m.ctrl.T.Helper()
...
func (mr *MockTaskServiceMockRecorder) SelectWorker(ctx, taskID, userID, workerID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskServiceMockRecorder) UpdateTaskMeta(ctx, taskID, userID, data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
