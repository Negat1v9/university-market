...
//
//	mockgen -source=./internal/services/worker/type.go -destination=./internal/services/worker/mock/service_mock.go -package=worker_service_mock
//
...
func (mr *MockWorkerServiceMockRecorder) Create(ctx, userID, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWorkerServiceMockRecorder) IsWorker(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWorkerServiceMockRecorder) RespondOnTask(ctx, workerID, taskID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWorkerServiceMockRecorder) Responds(ctx, workerID, v any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// SendTaskFiles mocks base method.
func (m *MockWorkerService) SendTaskFiles(ctx context.Context, workerID, taskID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendTaskFiles", ctx, workerID, taskID)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendTaskFiles indicates an expected call of SendTaskFiles.
func (mr *MockWorkerServiceMockRecorder) SendTaskFiles(ctx, workerID, taskID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendTaskFiles", reflect.TypeOf((*MockWorkerService)(nil).SendTaskFiles), ctx, workerID, taskID)
}
...
func (mr *MockWorkerServiceMockRecorder) TaskInfo(ctx, workerID, taskID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWorkerServiceMockRecorder) TasksResponded(ctx, workerID, v any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWorkerServiceMockRecorder) Update(ctx, workerID, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWorkerServiceMockRecorder) Worker(ctx, workerID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWorkerServiceMockRecorder) WorkerPublicInfo(ctx, workerID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
